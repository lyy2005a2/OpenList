...
import (
	...
	stream "github.com/qiniu/go-sdk/v7/internal/stream"
)

func FsStreamUp(c *gin.Context) {
	name := c.GetHeader("File-Name")
	...
	if strings.Contains(name, "/") {
		common.ErrorResp(c, errs.InvalidName, 400)
		return
	}
	if errs.HasIgnoredFile(name) {
